...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_device_dm_fs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device_dm_fs.xml \
    $(LOCAL_PATH)/configs/audio/audio_device_sm_aw.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device_sm_aw.xml \
    $(LOCAL_PATH)/configs/audio/audio_device_sm_fs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_device_sm_fs.xml \
